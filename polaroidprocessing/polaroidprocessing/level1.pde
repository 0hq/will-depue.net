...
PVector[] masterPositionsLevel1 = {new PVector(0, 101, 0), new PVector(100, 50, 80), new PVector(-100, 50, -80), new PVector(600, 50, -80), new PVector(300, 50, 0), new PVector(-300, 50, 80), new PVector(-300, 50, -80)};
color[] masterColorsLevel1 = {color(140), color(255), color(255), color(255), color(255), color(255), color(255)};
PShape[] masterShapesLevel1 = new PShape[7]; 
